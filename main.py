...
for cont in contours:
    ...
    print("{}-砾石面积:{}".format(count,ares*ratio),end="  ") #打印出每个砾石的面积
...
print("砾石平均面积:{}".format(round(ares_avrg/count,2)*ratio)) #打印出每个砾石的面积

cv2.namedWindow("imagshow", cv2.WINDOW_KEEPRATIO)   #创建一个窗口
cv2.imshow('imagshow', img)    #显示原始图片
